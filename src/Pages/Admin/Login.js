...
const AdminLogin = () => {
  ...
  return (
    <div className="container-fluid vh-100 d-flex flex-column p-0" style={{ backgroundColor: "#f8f9fa" }}>
      {/* Header */}
      <header className="py-3" style={{ backgroundColor: "rgba(0, 106, 193, 0.95)" }}>
        <div className="container">
          <div className="d-flex flex-column flex-md-row align-items-center">
            <div className="text-center text-md-start">
              <h1 className="m-0 text-white">MK Audiology</h1>
              <p className="m-0 text-white-50">Hear Well Center</p>
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="col-12 col-md-8 col-lg-6 col-xl-5">
              <div className="card shadow-sm border-0">
                <div className="card-body p-4 p-md-5">
                  <h2 className="card-title text-center mb-3" style={{ color: "rgba(0, 106, 193, 0.95)" }}>Admin Portal</h2>
                  ...
                  <form onSubmit={handleLogin}>
                    ...
                    <button 
                      ...
                      style={{ backgroundColor: "rgba(0, 106, 193, 0.95)", color: "white" }}
                    >
                      Sign In
                    </button>
                  </form>
      ...
      {/* Footer */}
      <footer className="py-3" style={{ backgroundColor: "rgba(0, 106, 193, 0.95)" }}>
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
